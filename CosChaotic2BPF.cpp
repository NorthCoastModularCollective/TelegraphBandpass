...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("filename", "CosChaotic2BPF.dsp");
	...
	virtual void instanceResetUserInterface() {
		fEntry0 = FAUSTFLOAT(10.699999999999999f);
		fEntry1 = FAUSTFLOAT(10.699999999999999f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("CosChaotic2BPF");
		ui_interface->addNumEntry("Q", &fEntry3, 1.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addNumEntry("frequency", &fEntry2, 440.0f, 0.0f, 100.0f, 0.00999999978f);
		ui_interface->addNumEntry("g", &fEntry1, 10.6999998f, 0.0f, 100.0f, 0.00999999978f);
		ui_interface->addNumEntry("phaseOffset", &fEntry0, 10.6999998f, 0.0f, 100.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp2 = (1.0f / fRec5[0]);
			float fTemp3 = (((fTemp2 + fTemp1) / fTemp0) + 1.0f);
			fRec1[0] = ((float(input0[i]) + std::cos((fRec2[0] + (fRec3[0] * fRec0[1])))) - (((fRec1[2] * (((fTemp1 - fTemp2) / fTemp0) + 1.0f)) + (2.0f * (fRec1[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp0)))))) / fTemp3));
			float fTemp4 = (fTemp0 * fTemp3);
			fRec0[0] = ((0.5f * (fRec1[0] / fTemp4)) + (fRec1[2] * (0.0f - (0.5f / fTemp4))));
...
CosChaotic2BPF::CosChaotic2BPF() : AudioStream((fDSP = new mydsp())->getNumInputs(), new audio_block_t*[fDSP->getNumInputs()])
{
    fUI = new MapUI();
...
void CosChaotic2BPF::update(void)
{
#if MIDICTRL
...
void CosChaotic2BPF::setParamValue(const std::string& path, float value)
{
